                ...
                <ul class="navbar-nav mr-auto">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                            <a class="dropdown-item" href="/Digital Gram Panchayat/Scheme/view scheme/view.php">View Scheme</a>
                            <a class="dropdown-item" href="#">Apply Scheme</a>
                            <a class="dropdown-item" href="application_view.php">View Status</a>
                            <a class="dropdown-item" href="view_profile.php">Profile</a>
                        </div>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="Admin/About_Us.php">About Us</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="/Digital Gram Panchayat/Admin/Contact_Us.php">Contact Us</a>
                    </li>
                </ul>
            </div>
            <div class="button">
