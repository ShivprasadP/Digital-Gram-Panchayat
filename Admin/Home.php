                ...
                <ul class="navbar-nav mr-auto">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                            <a class="dropdown-item" href="view_application.php">View Applications</a>
                           
                            <a class="dropdown-item" href="/Digital Gram Panchayat/Scheme/manage scheme/index1.php">Manage Scheme</a>
