...
<body>
    ...
    <div class="container-fluid">
        <div class="wrapper">
            <h2 align="center">Income Certificate</h2>
            <p align="center">Please fill this form to get income certificate</p>
            <form action="" method="POST">
                ...
                <div class="form-group">
                    <label>Address:</label>
                    <textarea name="address" cols="30" rows="6" class="form-control" required></textarea>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    <label>Term & Condion:</label>
                    <label><input type="radio" name="gender" class="form-control">I accept the term & condition</label>
                </div>
                <div class="form-group">
                    <label>Aadhar Card of Applicant:</label>
                    <input type="file" name="pic" required>
                </div>
                <div class="form-group">
                    <label>Passport Size Photo of Applicant:</label>
                    <input type="file" name="pic" required>
                </div>
                <div class="form-group">
